...
public class IntNode {
     ...
     */
        ...
        public static IntNode removeAll(IntNode head, int e) {
            IntNode answer = head;
            //IntNode answer1 = head;
            // Special case when the first data equals e
            //IntNode temp = new IntNode(head.getValue(),head.getLink());
            for (IntNode temp = head; temp.getLink()!=null;temp = temp.getLink()) {
            	if (temp.getValue()==e) answer=temp;
            	else {
            		answer = temp;
            		break;
            	}
            }
            IntNode answer1 = answer;
          
            IntNode answer2 = answer1;
            IntNode temp = answer2;
            while (temp.getLink() !=null) {
            	if (temp.getLink().getValue()==e) {
            		IntNode pointer = temp.getLink();
        ...
        /**
         * Lab 4. #7 hasCycle method
         */
        public static boolean hasCycle(IntNode head) {
            if (head==null) return false;
            else {
                IntNode turtle = head, rabbit = head;
                while (turtle != null && rabbit != null && rabbit.link != null) {
                	turtle = turtle.link;
